...
{
    public class Studentsssses1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Studentsssses1Controller(ApplicationDbContext context)
        {
            _context = context;    
        }
        ...
        // GET: Studentsssses1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Studentsssses1/Create
